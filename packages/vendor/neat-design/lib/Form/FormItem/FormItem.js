...
var _FormItemStatus = require("../FormItemStatus");
...
function FormItem(props) {
  ...
  var _omit = (0, _omit2.default)(props, ['labelAlign', 'labelCol']),
   ...
   */
  var requiredProps = (0, _react.useMemo)(function () {
    if (!label) {
      return {
        required: false,
        optional: false
   ...
   */
  var handleStatusChange = (0, _react.useCallback)(function (_ref) {
  ...
  return (0, _jsxRuntime.jsx)(_antd.Form.Item, _objectSpread(_objectSpread({}, restProps), {}, {
    className: (0, _classnames2.default)(_defineProperty(_defineProperty({}, "".concat(prefixCls, "-form-item-focused"), focused), "".concat(prefixCls, "-form-item-empty-label"), !label), styles, className),
    label: (0, _jsxRuntime.jsx)(_Label.default, _objectSpread(_objectSpread({}, requiredProps), {}, {
      size: size,
      tooltips: tooltip,
      children: label
    })),
    ...
    children: typeof children === 'function' ? function () {
      ...
      return (0, _jsxRuntime.jsx)(_FormItemStatus.FunctionChildrenWrapper, {
        formItemFunctionalArgs: args,
        onStatusChange: handleStatusChange,
        children: children
      });
    } : (0, _jsxRuntime.jsx)(_FormItemStatus.ElementChildrenWrapper, {
