...
exports.neatButtonType2AntButtonType = exports.neatButtonSize2AntButtonSize = exports.neatButtonProps2AntButtonProps = exports.neatButtonIcon2AntButtonIcon = void 0;
...
var neatButtonType2AntButtonType = exports.neatButtonType2AntButtonType = function neatButtonType2AntButtonType(type) {
  switch (type) {
    case 'primary':
      return 'primary';
    case 'tertiary':
...
var neatButtonSize2AntButtonSize = exports.neatButtonSize2AntButtonSize = function neatButtonSize2AntButtonSize(size) {
  switch (size) {
    case 'small':
      return 'small';
    case 'medium':
...
var neatButtonIcon2AntButtonIcon = exports.neatButtonIcon2AntButtonIcon = function neatButtonIcon2AntButtonIcon(icon, props) {
  return props !== null && props !== void 0 && props.loading ? (0, _jsxRuntime.jsx)(_Loading.default, {
...
var neatButtonProps2AntButtonProps = exports.neatButtonProps2AntButtonProps = function neatButtonProps2AntButtonProps(props, options) {
  var type = props.type,
    size = props.size,
