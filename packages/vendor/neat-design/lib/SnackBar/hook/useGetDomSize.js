...
var useGetDomSize = function useGetDomSize(_ref) {
  ...
  var domResizeObserver = (0, _react.useRef)();
  var updateDomSize = (0, _react.useCallback)(function (dom) {
  ...
  var addDomListener = (0, _react.useCallback)(function (dom) {
    if (!dom) return;
...
var _default = exports.default = useGetDomSize;