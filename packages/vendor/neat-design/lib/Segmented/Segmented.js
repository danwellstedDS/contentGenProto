...
var Segmented = /*#__PURE__*/(0, _react.forwardRef)(function (_ref, ref) {
  var size = _ref.size,
  ...
  // 是否仅使用icon
  var onlyIcon = (0, _react.useMemo)(function () {
  ...
  return (0, _jsxRuntime.jsx)(_antd.Segmented, _objectSpread(_objectSpread({}, restProps), {}, {
    options: options,
    ref: ref,
