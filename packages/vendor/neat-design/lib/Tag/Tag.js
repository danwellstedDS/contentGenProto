...
var Tag = function Tag(_ref) {
  ...
  var tagSize = (0, _react.useMemo)(function () {
    return size || componentSize;
  }, [componentSize, size]);
  var closable = restProps.closable;
  var computedIcon = (0, _react.useMemo)(function () {
    if (!icon) {
      return icon;
    }
  ...
  var defaultCloseButtonRender = (0, _jsxRuntime.jsx)(_CloseButton.default, {
    tagName: "span",
    type: "circle",
  ...
  return (0, _jsxRuntime.jsx)(_antd.Tag, _objectSpread(_objectSpread({}, restProps), {}, {
    className: (0, _classnames.default)(styles, _defineProperty(_defineProperty(_defineProperty(_defineProperty({}, "".concat(prefixCls, "-tag-color-").concat(color), color), "".concat(prefixCls, "-tag-size-").concat(tagSize), tagSize), "".concat(prefixCls, "-tag-closable"), !!computedCloseIcon), "disabled", disabled), className),
    style: mergedStyle,
    icon: computedIcon,
