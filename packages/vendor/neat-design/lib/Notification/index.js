...
// Vendors
// Types
var useAntNotification = _antd.notification.useNotification,
  restProps = _objectWithoutProperties(_antd.notification, ["useNotification"]);
...
function applyIcon(method) {
  ...
  switch (method) {
    case 'success':
      return (0, _jsxRuntime.jsx)(_SuccessCircleFilled2.default, _objectSpread({}, props));
    case 'info':
      return (0, _jsxRuntime.jsx)(_InfoCircleFilled2.default, _objectSpread({}, props));
    case 'warning':
      return (0, _jsxRuntime.jsx)(_WarningCircleFilled2.default, _objectSpread({}, props));
    case 'error':
      return (0, _jsxRuntime.jsx)(_WarningCircleFilled2.default, _objectSpread({}, props));
    default:
      return (0, _jsxRuntime.jsx)(_InfoCircleFilled2.default, _objectSpread({}, props));
...
var notification = _objectSpread(_objectSpread({}, restProps), {}, {
  ...
  success: applyAntNotification(_antd.notification, 'success'),
  info: applyAntNotification(_antd.notification, 'info'),
  warning: applyAntNotification(_antd.notification, 'warning'),
  error: applyAntNotification(_antd.notification, 'error'),
  open: applyAntNotification(_antd.notification, 'info')
});
