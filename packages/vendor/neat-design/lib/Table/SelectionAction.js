...
var _useShowSelectAll2 = _interopRequireDefault(require("./hooks/useShowSelectAll"));
var _SelectionActionBar = _interopRequireDefault(require("./SelectionActionBar"));
var _SelectionActionPopup = _interopRequireDefault(require("./SelectionActionPopup"));
...
var SelectionAction = function SelectionAction(_ref) {
  ...
  var dataTotal = (0, _react.useMemo)(function () {
    var _child$props;
  ...
  var _useControllableValue = (0, _ahooks.useControllableValue)((_child$props$rowSelec = child === null || child === void 0 ? void 0 : child.props.rowSelection) !== null && _child$props$rowSelec !== void 0 ? _child$props$rowSelec : {}, {
      defaultValue: [],
  ...
  var _useControllableValue3 = (0, _ahooks.useControllableValue)(_objectSpread({}, tableSelectionPopProps), {
      valuePropName: 'open',
  ...
  var memoSelectedRowKeysRef = (0, _react.useRef)([]);
  var handleOpenChange = (0, _react.useMemo)(function () {
    return (0, _debounce.default)(function (selectedRowKeys) {
      if (!(0, _isEqual.default)(selectedRowKeys, memoSelectedRowKeysRef.current)) {
  ...
  var _useShowSelectAll = (0, _useShowSelectAll2.default)(selectedRowKeys),
  ...
  return (0, _jsxRuntime.jsx)(_SelectionActionPopup.default, {
    ...
    content: (0, _jsxRuntime.jsx)(_SelectionActionBar.default, {
    ...
    children: /*#__PURE__*/(0, _react.cloneElement)(child, {
      rowSelection: (0, _isNil.default)(child.props.rowSelection) ? child.props.rowSelection : _objectSpread(_objectSpread({}, child.props.rowSelection), {}, {
        selectedRowKeys: selectedRowKeys,
...
var _default = exports.default = SelectionAction;