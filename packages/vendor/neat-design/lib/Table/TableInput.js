...
var TableInput = function TableInput(_ref) {
  ...
  var InputToken = (0, _useTokenMapping.default)(tokenMapping);
  ...
  return (0, _jsxRuntime.jsx)(_.ConfigProvider, {
    ...
    children: (0, _jsxRuntime.jsx)(_.Input, _objectSpread(_objectSpread({}, restProps), {}, {
      className: (0, _classnames.default)("".concat(prefixCls, "-table-input"), className),
      size: computedSize
    }))
  });
};
