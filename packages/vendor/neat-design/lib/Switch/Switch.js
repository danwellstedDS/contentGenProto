...
var Switch = /*#__PURE__*/(0, _react.forwardRef)(function (_ref, ref) {
  ...
  var cSize = (0, _useConvertSize.default)(size !== null && size !== void 0 ? size : componentSize);
  var css = (0, _style.default)({
    size: size
  });
  var applyingLargeSize = cSize === 'large';
  var suffix = applyingLargeSize && cSize;
  var largeSizeCls = suffix ? "".concat(prefixCls, "-switch-").concat(suffix) : '';
  var mergedCls = "".concat(largeSizeCls, " ").concat(className !== null && className !== void 0 ? className : '');
  var antdSwitchSize = cSize === 'large' ? undefined : cSize;
  return (0, _jsxRuntime.jsx)(_antd.Switch, _objectSpread(_objectSpread({
    className: mergedCls,
    size: antdSwitchSize
  }, restProps), {}, {
    ref: ref,
