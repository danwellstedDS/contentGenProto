...
function genToken(token) {
  return {
    ...
    'switch-color-bg-off-hover': _neatDesignToken.ladderColor['neutral-9'],
    'switch-color-bg-off-focus': _neatDesignToken.ladderColor['neutral-11'],
    'switch-color-bg-off-press': _neatDesignToken.ladderColor['neutral-9'],
    'switch-color-bg-off-loading': _neatDesignToken.ladderColor['neutral-11'],
    'switch-color-bg-off-disabled': _neatDesignToken.ladderColor['neutral-7'],
    'switch-color-border-off': _neatDesignToken.ladderColor['neutral-15'],
