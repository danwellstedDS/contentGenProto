...
var defaultEnterBtn = (0, _jsxRuntime.jsx)(_Button.default, {
  type: "primary",
  children: "Search"
});
var defaultClearIcon = (0, _jsxRuntime.jsx)(_CloseCircleFilled2.default, {});
var Search = /*#__PURE__*/(0, _react.forwardRef)(function (_ref, ref) {
  ...
  var cls = (0, _classnames.default)(_defineProperty(_defineProperty({}, "".concat(prefixCls, "-input-readonly"), readOnly), customCls, true), styles);
  ...
  var searchBtnRender = (0, _react.useCallback)(function () {
    var btn = addonAfter || enterButton;
    switch (btn) {
      case (0, _isBoolean.default)(btn):
        return btn ? defaultEnterBtn : null;
      case (0, _isString.default)(btn):
  ...
  var cloneSearchBtn = (0, _react.useMemo)(function () {
    var SearchBtn = searchBtnRender();
    if (SearchBtn === null) return SearchBtn;
    // @ts-ignore
    return /*#__PURE__*/(0, _react.cloneElement)(SearchBtn, {
      onClick: handleSearch,
      loading: loading,
      size: size
    });
  }, [handleSearch, loading, searchBtnRender, size]);
  var computedAllowClear = (0, _react.useMemo)(function () {
    if ((0, _isBoolean.default)(allowClear)) {
      return allowClear ? {
        clearIcon: /*#__PURE__*/(0, _react.cloneElement)(defaultClearIcon, {
          onClick: handleClear
        })
      } : allowClear;
    }
    ...
    return {
      clearIcon: /*#__PURE__*/(0, _react.cloneElement)(btn, {
        onClick: handleClear
      })
    };
  }, [allowClear, handleClear]);
  return (0, _jsxRuntime.jsxs)(_antd.Space.Compact, {
    children: [(0, _jsxRuntime.jsx)(_antd.Input, _objectSpread({
      className: cls,
      ref: ref,
      size: cSize,
