...
function neatToken2AntToken(theme) {
  var token = theme.components.InputNumber;
  return {
    ...
    inputFontSize: token['input-font-size-medium'],
    inputFontSizeLG: token['input-font-size-large'],
    inputFontSizeSM: token['input-font-size-small'],
