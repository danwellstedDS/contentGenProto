...
exports.getSelectAllValue = getSelectAllValue;
exports.getSelectAllValueByPaths = getSelectAllValueByPaths;
 ...
 * @param path
 */
function preOrderTraverse(option, fieldNames, callback) {
 ...
 * @param valuePath
 */
function getSelectAllValue(options, valueKey, childrenKey) {
 ...
 * @param valuePath
 */
function getSelectAllValueByPaths(optionsPaths, valueKey, childrenKey) {
  var valuePath = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : [];
