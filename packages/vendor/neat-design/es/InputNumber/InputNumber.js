...
var InputNumber = /*#__PURE__*/forwardRef(function (_ref, ref) {
  var className = _ref.className,
    ...
    controls = _ref$controls === void 0 ? {
      upIcon: _jsx(_ArrowUpOutlined, {}),
      downIcon: _jsx(_ArrowDownOutlined, {})
    } : _ref$controls,
    inputDirection = _ref.inputDirection,
    restProps = _objectWithoutProperties(_ref, _excluded);
  var prefixCls = usePrefixCls();
  var cSize = useConvertSizeMediumAsMiddle(restProps === null || restProps === void 0 ? void 0 : restProps.size);
