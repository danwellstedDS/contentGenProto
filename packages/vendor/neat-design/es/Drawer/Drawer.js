...
var Drawer = function Drawer(_ref) {
  var rootClassName = _ref.rootClassName,
    ...
    closeIcon = _ref$closeIcon === void 0 ? _jsx(CloseButton, {
      tagName: "span"
    }) : _ref$closeIcon,
   ...
   */
  var getDrawerWidth = useCallback(function () {
   ...
   */
  var _useState = useState(getDrawerWidth()),
  ...
  return _jsx(DrawerContext.Provider, {
    ...
    children: _jsx(AntDrawer, _objectSpread(_objectSpread({}, restProps), {}, {
      rootClassName: classNames(styles, "".concat(prefixCls, "-drawer-").concat(size), rootClassName),
      width: drawerWidth,
      closeIcon: closeIcon
    }))
  });
