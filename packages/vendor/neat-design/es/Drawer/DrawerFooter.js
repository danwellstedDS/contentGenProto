...
// Styles
import useStyle from "./style/drawerFooter";
...
var DrawerFooter = function DrawerFooter(_ref) {
   ...
   */
  var mergedDirection = useMemo(function () {
    if (direction) {
      return direction;
    }
  ...
  return _jsx(Action, _objectSpread(_objectSpread({}, restProps), {}, {
    className: classNames(styles, "".concat(prefixCls, "-drawer-footer-content"), className),
