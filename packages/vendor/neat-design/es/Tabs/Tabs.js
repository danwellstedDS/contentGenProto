...
import useTabBarExtraContent from "./hook/useTabBarExtraContent";
...
var Tabs = /*#__PURE__*/forwardRef(function (_ref, ref) {
   ...
   */
  var tabsRef = useForwardedRef(ref);
   ...
   */
  var getScrollEl = useCallback(function () {
   ...
   */
  var getDefaultRemoveIconSize = useCallback(function () {
    switch (size) {
      case 'large':
        return 18;
      default:
  ...
  var mergedRemoveIcon = useMemo(function () {
    return removeIcon ? removeIcon : _jsx(CloseButton, {
      tagName: "span",
      type: "circle",
   ...
   */
  var navScrollLeftButton = useMemo(function () {
    return _jsx(NavScrollButton, {
   ...
   */
  var navScrollRightButton = useMemo(function () {
    return _jsx(NavScrollButton, {
      scrollEl: getScrollEl(),
      direction: "right",
   ...
   */
  var _useTabBarExtraConten = useTabBarExtraContent(),
  ...
  return _jsx("div", {
    ...
    children: _jsx(AntTabs, _objectSpread(_objectSpread({}, restProps), {}, {
      className: classNames(styles, _defineProperty({}, "".concat(prefixCls, "-tabs-editable-line"), type === 'editable-line'), className),
      size: mergedSize,
      type: mergedType,
      hideAdd: hideAdd,
