...
import useOptions from 'rc-cascader/lib/hooks/useOptions';
...
// Vendors
import { fillFieldNames } from 'rc-cascader/lib/utils/commonUtil';
import { toPathOptions } from 'rc-cascader/lib/utils/treeUtil';
import { preOrderTraverse } from "../Util";
...
var MultipleCascader = function MultipleCascader(_ref) {
   ...
   */
  var resetValueRef = useRef(value);
   ...
   */
  var getValueOptions = useCallback(function (value) {
   ...
   */
  var updateCascaderValue = useCallback(function (nextCascaderValue, selectedOptions) {
   ...
   */
  var getFilteredPaths = useCallback(function () {
    var result = [];
    if (!searchValue || !mergedShowSearch) {
      mergedOptions.forEach(function (optionRoot) {
        preOrderTraverse(optionRoot, mergedFieldNames, function (option, _parentNode, _depth, path) {
   ...
   */
  var handleChange = useCallback(function (value, selectedOptions) {
   ...
   * Merge popupRender.
   */
  var mergedDropdownRender = useCallback(function (menus) {
    if (popupRender) {
      return popupRender(menus);
    }
    var filteredPaths = getFilteredPaths();
    return _jsxs(_Fragment, {
      children: [menus, _jsx(ActionBar, {
        loading: loading,
        select: {
  ...
  return _jsx(AntCascader, _objectSpread(_objectSpread({}, restProps), {}, {
    loadData: loadData,
    open: cascaderOpen,
