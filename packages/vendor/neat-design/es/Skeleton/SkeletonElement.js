...
var SkeletonElement = function SkeletonElement(_ref) {
  ...
  // 转换 size
  var mergedSize = useConvertSize(size);
  return _jsx(Element, _objectSpread(_objectSpread({}, restProps), {}, {
    className: classNames(_defineProperty({}, "".concat(prefixCls, "-active"), active), className),
    prefixCls: prefixCls,
    size: mergedSize
  }));
};
