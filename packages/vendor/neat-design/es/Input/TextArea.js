...
// Styles
import useStyle, { useTextAreaStyle } from "./style";
...
var TextArea = /*#__PURE__*/forwardRef(function (_ref, ref) {
  ...
  var textareaStyles = useTextAreaStyle({
    size: size
  });
  var cls = classNames(_defineProperty({}, "".concat(prefixCls, "-input-readonly"), readOnly), customCls, commonStyles, textareaStyles);
  var computedAllowClear = allowClear === true ? {
    clearIcon: _jsx(_CloseCircleFilled, {})
  } : allowClear;
  return _jsx(AntInput.TextArea, _objectSpread(_objectSpread({
