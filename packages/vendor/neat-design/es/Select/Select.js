...
import useSelectOverlayStyle from "./style/overlay";
...
var Select = /*#__PURE__*/forwardRef(function (_ref, ref) {
  ...
  var options = _ref.options,
    ...
    menuItemSelectedIcon = _ref$menuItemSelected === void 0 ? _jsx(_SuccessOutlined, {}) : _ref$menuItemSelected,
  ...
  var overlayStyles = useSelectOverlayStyle();
  var _useState = useState((_restProps$open = restProps === null || restProps === void 0 ? void 0 : restProps.open) !== null && _restProps$open !== void 0 ? _restProps$open : false),
  ...
  var computedOptions = useMemo(function () {
    ...
    return options === null || options === void 0 || (_options$map = options.map) === null || _options$map === void 0 ? void 0 : _options$map.call(options, function (option) {
      ...
      return _objectSpread(_objectSpread({}, restOption), {}, _defineProperty({}, labelKey, _jsxs(_Fragment, {
        children: [_jsx("span", {
  ...
  var cls = classNames(styles, restProps === null || restProps === void 0 ? void 0 : restProps.className, _defineProperty({}, "".concat(prefixCls, "-select-readonly"), readOnly));
  ...
  var handleDropdownVisibleChange = function handleDropdownVisibleChange(open) {
    if (!isBoolean(restProps === null || restProps === void 0 ? void 0 : restProps.open)) {
      setDropdownVisible(open);
    }
    onDropdownVisibleChange === null || onDropdownVisibleChange === void 0 || onDropdownVisibleChange(open);
  };
  var computeSuffixIcon = useMemo(function () {
   ...
   */
  var computedMenuItemSelectedIcon = useMemo(function () {
  ...
  var _useState3 = useState(restProps === null || restProps === void 0 ? void 0 : restProps.defaultValue),
   ...
   */
  var mergedPopupCls = classNames(popupClassName, overlayStyles, _defineProperty({}, "select-popup-".concat(restProps === null || restProps === void 0 ? void 0 : restProps.mode), !!(restProps !== null && restProps !== void 0 && restProps.mode)));

  /**
   * validate here is two-way binding
   */
  var isTwoWayBinding = useMemo(function () {
   ...
   */
  var customOptionRender = useMemo(function () {
  ...
  return _jsx(AntSelect, _objectSpread(_objectSpread({}, restProps), {}, {
    ref: ref,
    size: cSize,
    tagRender: tagRender,
