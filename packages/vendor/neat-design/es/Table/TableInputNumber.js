...
// Components
import { ConfigProvider, InputNumber } from "../";
...
var TableInputNumber = function TableInputNumber(_ref) {
  ...
  var InputNumberToken = useTokenMapping(tokenMapping);
  ...
  return _jsx(ConfigProvider, {
    ...
    children: _jsx(InputNumber, _objectSpread(_objectSpread({}, restProps), {}, {
      className: classNames("".concat(prefixCls, "-table-input-number"), className),
      size: computedSize
    }))
  });
};
