...
// Styles
import useStyle from "./style/SelectionAction";
...
var SelectionActionPopover = function SelectionActionPopover(_ref) {
   ...
   */
  var handleMeasure = useCallback(function (size) {
    setWidth(size.offsetWidth);
  }, []);
  return _jsx(Popover, _objectSpread(_objectSpread({}, restProps), {}, {
    ...
    classNames: _objectSpread(_objectSpread({}, classNames), {}, {
      root: classnames("".concat(prefixCls, "-table-selection-action-pop"), style, classNames === null || classNames === void 0 ? void 0 : classNames.root)
    }),
...
var SelectionActionPopup = function SelectionActionPopup(_ref2) {
  ...
  if (tableSelectionPopType === 'snackBar') {
    return _jsx(SnackBar, _objectSpread(_objectSpread(_objectSpread({}, defaultSnackBarProps), tableSelectionPopProps), {}, {
      content: content,
      children: children
    }));
  }
  return _jsx(SelectionActionPopover, _objectSpread(_objectSpread({}, tableSelectionPopProps), {}, {
    content: content,
    children: children
  }));
};
