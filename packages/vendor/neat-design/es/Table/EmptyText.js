...
import _FolderOutlined from "@derbysoft/neat-design-icons/lib/icons-react/FolderOutlined";
...
import useStyle from "./style/EmptyText";
...
var EmptyText = function EmptyText(_ref) {
  var className = _ref.className,
    ...
    image = _ref$image === void 0 ? _jsx(_FolderOutlined, {}) : _ref$image,
    text = _ref.text,
   ...
   */
  var computedText = useMemo(function () {
   ...
   */
  var computedDescription = useMemo(function () {
   ...
   */
  var defaultRender = _jsxs(_Fragment, {
    children: [!loading && image && _jsx("div", {
      className: "".concat(prefixCls, "-empty-image"),
      children: image
    }), !loading && computedText && _jsx("div", {
      className: "".concat(prefixCls, "-empty-text"),
      children: computedText
    }), !loading && computedDescription && _jsx("div", {
  ...
  return _jsx("div", _objectSpread(_objectSpread({}, restProps), {}, {
    className: classNames(styles, "".concat(prefixCls, "-empty"), className),
