...
const LoadingSMStatic: FC<Props> = React.forwardRef<HTMLSpanElement, HTMLSpanElement>(({ className }, ref) => <span className={className} style={{
...
const icon = (
    ...
    <Icon {...props} ref={ref} component={LoadingSMStatic} />
);
...
const LoadingSM = React.forwardRef<HTMLSpanElement, BaseIconProps>(icon)
