...
var IconBase = function (props) {
    ...
    (0, utils_1.useInsertStyles)(svgRef);
    return (0, jsx_runtime_1.jsx)(Icon, __assign({ className: className, onClick: onClick, style: style, width: '1em', height: '1em', fill: 'currentColor', "aria-hidden": 'true' }, restProps, twoToneColors, { ref: svgRef }));
};
