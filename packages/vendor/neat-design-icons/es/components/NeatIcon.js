...
var Icon = React.forwardRef(function (props, ref) {
    ...
    var _f = React.useContext(Context), _g = _f.prefixCls, prefixCls = _g === void 0 ? 'neaticon' : _g, rootClassName = _f.rootClassName, _h = _f.twoToneColors, twoToneColors = _h === void 0 ? defaultTwoToneColors : _h, _j = _f.disabledTwoToneColors, disabledTwoToneColors = _j === void 0 ? defaultDisabledTwoToneColors : _j, _k = _f.inverseTwoToneColors, inverseTwoToneColors = _k === void 0 ? defaultInverseTwoToneColors : _k;
    var componentName = (Component || {}).displayName;
    if (!Component)
        return null;
    var classString = classNames(rootClassName, prefixCls, (_a = {},
    ...
    return (_jsx("span", __assign({ role: "img", "aria-label": componentName }, restProps, { ref: ref, tabIndex: iconTabIndex, onClick: onClick, className: classString, children: _jsx(ReactIcon, __assign({ icon: Component }, twoToneProps, { style: svgStyle })) })));
});
